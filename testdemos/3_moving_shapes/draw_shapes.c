...
moving_rectangle(rectangle *to_draw)
{
  ...
  if ( (to_draw->rect1_col ) <= -10 ||
       (to_draw->rect2_col ) <= -10) { 
...
moving_circle(void)
{
  ...
  typeCtrl.random_val = cir1.cir_y; //USED TO CHOOSE A NEW RANDOM TYPE REC
